...
function FightRow({
  ...
  return (
    <div className="flex items-center justify-between gap-2 py-1 border-b border-outline-subtle last:border-b-0">
      <div className="flex flex-col gap-0.5 min-w-0">
        {winner && loser ? (
          <span className="text-body-sm">
            <span className="font-semibold text-on-surface">{winner.name}</span>
